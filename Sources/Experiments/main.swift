...
// var locations: [Location] = [.building("Library")]
// locations.append(.house([Person(name: "Anthony")]))
// locations.append(.house([Person(name: "Stretch")]))
// locations.append(.house([Person(name: "Abs")]))
// locations.append(.house([Person(name: "Avi")]))
// locations.append(.house([Person(name: "Kinky One")]))
// locations.append(.house([Person(name: "German One")]))
// let map = Map.generate(for: locations)
// print(map.rendering)
